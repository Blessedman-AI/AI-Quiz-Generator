...
//       questions.map((q) => (q.type === 'multi-choice' ? [] : null))
//     )
//   );
...
//       questions.questionType === 'multi-choice'
//     ) {
...
//         const selectedArr = selectedAnswers[index] || [];
...
//     ${
//       // For single choice questions or when the option is selected in multi-choice
...
//     }
//     ${
//       // Highlight wrong selections when submitted
//       isAnswerSubmitted &&
//       // For single choice - selected wrong answer
//       ((!Array.isArray(selectedAnswers[currentQuestionIndex]) &&
//         selectedAnswers[currentQuestionIndex] === option &&
//         option !== currentQuestion.correctAnswer) ||
//         // For multi-choice - selected wrong answer
//         (Array.isArray(selectedAnswers[currentQuestionIndex]) &&
//           selectedAnswers[currentQuestionIndex].includes(option) &&
//           !(
//             Array.isArray(currentQuestion.correctAnswer) &&
...
//                 onClick={() => handleAnswerSelect(option)}
//               >
//                 {/* Radio/checkbox indicators would go here */}
//                 <span>{option}</span>
//               </div>
//             ))}
//           </div>
